...
from grpc.tests.peebeetwos.tests.testing.proto import requests_pb2
from grpc.tests.peebeetwos.tests.testing.proto import services_pb2
from grpc.tests.peebeetwos.tests.testing.proto import services_pb2_grpc
...
def _run_stream_stream(stub):
    ...
    if (first_responses == _application_common.TWO_STREAM_STREAM_RESPONSES and
        second_responses == _application_common.TWO_STREAM_STREAM_RESPONSES and
        not unexpected_extra_response):
      return _SATISFACTORY_OUTCOME
    else:
      return _UNSATISFACTORY_OUTCOME
